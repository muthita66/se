...
export const TeacherFitnessService = {
    ...
    async upsertFitnessCriteria(data: any) {
        const { id, test_name, grade_level, gender, age_min, age_max, value_min, value_max, score, description, academic_year, unit, passing_threshold } = data;
        ...
        const payload: any = {
            ...
            value_min: value_min ? String(value_min) : null,
            value_max: value_max ? String(value_max) : null,
